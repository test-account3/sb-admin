  ...
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      (0, _postcssValueParser2.default)(decl.value).walk(function (node) {
        ...
        if (type === "function" && FUNC_REPRESENTATIONS.indexOf(value.toLowerCase()) !== -1) {
          ...
          for (var i = 0, l = namedColors.length; i < l; i++) {
            ...
            if (_representations2.default[_namedColor].func.indexOf(normalizedFunctionString.toLowerCase()) !== -1) {
        ...
        for (var _i = 0, _l = namedColors.length; _i < _l; _i++) {
          ...
          if (_representations2.default[namedColor].hex.indexOf(value.toLowerCase()) !== -1) {
