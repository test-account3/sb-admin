...
exports.default = function (actual) {
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      ...
      (0, _utils.styleSearch)({ source: declString.toLowerCase(), target: valuePrefixes }, function (match) {
        if (match.startIndex <= prop.length) {
          return;
        }
        var fullIdentifier = /^(-[a-z-]+)\b/i.exec(declString.slice(match.startIndex))[1];
